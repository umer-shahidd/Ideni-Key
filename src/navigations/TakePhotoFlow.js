...
const TakePhotoFlow = () => {
  return (
    <Stack.Navigator
    >
      <Stack.Screen component={WelcomScreen} name={Screens.welcomScreen} options={{
        headerShown: false
      }} />
      <Stack.Screen component={TakePictureScreen} name={Screens.takePhotScreen} options={{

        headerShown: false
      }} />
      <Stack.Screen component={VideoScreen} name={Screens.videoScreen} options={{ headerShown: false }} />
      <Stack.Screen component={TakeSecondImage} name={Screens.TakesecondPhoto} options={{
      ...
      <Stack.Screen component={ImageSelection} name={Screens.ImageSelection} options={{ headerShown: false }} />
